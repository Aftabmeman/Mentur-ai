...
import { Loader2, ChevronRight, Globe, SeparatorHorizontal } from "lucide-react"
          ...
          {step === 1 ? (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Button onClick={() => setStep(2)} disabled={!email || !password || !name} className="w-full h-14 rounded-2xl font-bold text-lg shadow-xl shadow-primary/20">
            ...
            <form onSubmit={handleSignup} className="space-y-6">
              <div className="space-y-3 text-center">
                ...
                <label className="text-sm font-black uppercase tracking-widest block">Final Step: Language Style</label>
                <p className="text-xs text-slate-500 font-medium">Choose your academic feedback mix.</p>
                <Select value={language} onValueChange={setLanguage}>
                  <SelectTrigger className="h-16 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none font-bold text-lg px-8 shadow-inner">
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="flex gap-3">
                ...
                <Button type="submit" className="flex-[2] h-14 rounded-2xl font-bold text-lg shadow-xl shadow-primary/20" disabled={loading}>
